...
public class Grmf implements GroupRecommender {
	...
	public Grmf(int numFactors, int numIters, double regularization, double learningRate, Function<Iterator<Double>, Double> merger) {
		this.merger = merger;
